...
"for s21_grep.c VAR"
"-e int s21_grep.c s21_grep.h Makefile VAR"
"-e for s21_grep.c VAR"
"-e regex s21_grep.c"
"-e void s21_grep.c Makefile"
)

declare -a extra=(
"-n for test_1_grep.txt test_2_grep.txt"
"-n for test_1_grep.txt"
"-n -e a test_1_grep.txt"
...
"-ech test_1_grep.txt test_2_grep.txt"
"-ne out test_5_grep.txt"
...
"-e is test_6_grep.txt"
"-e ing is test_6_grep.txt"
"-c -e . test_1_grep.txt"
